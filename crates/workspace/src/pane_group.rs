use crate::{
    AppState, CollaboratorId, FollowerState, Pane, Workspace, WorkspaceActiveCall,
    WorkspaceSettings,
...
pub struct PaneRenderContext<'a> {
    ...
    pub active_call: Option<&'a Entity<WorkspaceActiveCall>>,
        ...
        match leader_id {
            CollaboratorId::PeerId(peer_id) => {
                #[cfg(feature = "collab")]
                {
                    ...
                    let is_in_unshared_view =
                        follower_state.active_view_id.is_some_and(|view_id| {
                            !follower_state
